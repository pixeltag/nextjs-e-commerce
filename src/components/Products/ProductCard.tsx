...
export const ProductCard = ({ product, onAddToCart }: ProductCardType) => {
    const { id, title, images, sale, categories, price } = product;
    return (
        <div className="bg-white mb-4">
            <div className='overflow-hidden relative pt-16'>
                <div className='bg-gray relative h-96 group'>
                    ...
                    <button onClick={() => onAddToCart(product)} className='bg-blue uppercase text-white w-full p-4 absolute bottom-0 opacity-0 group-hover:opacity-100 ease-in-out duration-300'>Add to Cart</button>
                </div>
